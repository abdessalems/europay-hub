...
| 03 | [Business Rules Catalogue](03-business-rules.md) | Numbered, testable rules (BR-001…) | ✅ Phase 1–3 |
| 04 | [User Stories & Use Cases](04-user-stories-and-use-cases.md) | Actor-goal stories with use-case detail | ✅ Phase 1–3 |
| 05 | [Acceptance Criteria](05-acceptance-criteria.md) | Given/When/Then per story | ✅ Phase 1–3 |
| 06 | [API Contracts](06-api-contracts.md) | Request/response schemas, error codes | ✅ Phase 1–3 |
...
| — | [diagrams/](diagrams/) | BPMN, sequence, class, ER (Mermaid) — [Phase 1](diagrams/phase1-iam-merchant.md) · [Phase 2](diagrams/phase2-order-customer.md) · [Phase 3](diagrams/phase3-payment.md) | 🔄 per phase |
